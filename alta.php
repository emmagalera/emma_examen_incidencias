...
if(isset($_REQUEST['enviar'])){
      ...
      $contador=count($_SESSION['incidencias']);
      $_SESSION['num_incidencia']=$contador+1;
      ...
      $tipo_incidencia=$_REQUEST['tipo'];//SELECT
      $fecha_hora= date('d-m-Y H:i:s');
      $lugar=$_REQUEST['lugar'];//INPUT
      $ip=$_SERVER['REMOTE_ADDR'];
      $descripcion=$_REQUEST['descripcion']; //INPUT TEXTAREA

     /* echo $_SESSION['num_incidencia'],'<br>',$urgencia,'<br>',
      $tipo_incidencia,'<br>',$fecha_hora,'<br>',$lugar,'<br>',$ip,'<br>',$descripcion;*/

      //Introduccion de incidencia al array
      $_SESSION['incidencias'][]=array($_SESSION['num_incidencia'],$urgencia,$tipo_incidencia,$fecha_hora,$lugar,$ip,$descripcion);
      echo '
            <pre>
